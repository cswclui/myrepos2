...
Create the deployment of the three apps.
...
```text
controlplane $ kubectl get all --namespace=nginx-ingress
NAME                                READY   STATUS    RESTARTS   AGE
pod/nginx-ingress-b48d8dd79-qwlmv   1/1     Running   0          23s

NAME                    TYPE       CLUSTER-IP      EXTERNAL-IP   PORT(S)                      AGE
service/nginx-ingress   NodePort   10.111.87.208   172.17.0.9    80:30343/TCP,443:31332/TCP   23s

NAME                            READY   UP-TO-DATE   AVAILABLE   AGE
deployment.apps/nginx-ingress   1/1     1            1           23s

NAME                                      DESIRED   CURRENT   READY   AGE
replicaset.apps/nginx-ingress-b48d8dd79   1         1         1       23s
```
